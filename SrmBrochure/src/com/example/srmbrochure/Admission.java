...
public class Admission extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button home1=(Button) findViewById(R.id.apply);
		home1.setOnClickListener(new View.OnClickListener(){
			public void onClick(View view){
				Intent myintent= new Intent(view.getContext(), Apply.class);
				startActivityForResult(myintent,0);
			
			}
		});
		Button home2=(Button) findViewById(R.id.elgi);
		home2.setOnClickListener(new View.OnClickListener(){
			public void onClick(View view){
				Intent myintent= new Intent(view.getContext(), Eligibility.class);
				startActivityForResult(myintent,0);
